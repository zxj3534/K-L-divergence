function [num_8_cycles , VN_in_cycles_number , CN_in_cycles_number] = count_8_cycles_II(H, cn , VN_in_cycles_number , CN_in_cycles_number)
num_8_cycles = 0;
M = size(H, 1);
for m1 = 1 : M - 3
    for i1 = 1 : cn(m1)
                                                ...
                                                for m4 = m2 + 1 : m3 - 1
                                                    for i4 = 1 : cn(m4)
                                                        ...
                                                        if index_6 == index_5
                                                            for j3 = 1 : cn(m4)
                                                                index_7 = H(m4, j3);
                                                                if index_7 == index_6 || index_7 == index_3 || index_7 == index_2
                                                                    continue;
                                                                else
                                                                    for j4 = 1 : cn(m1)
                                                                        index_8 = H(m1, j4);
